...
var cookieDomain = "http://arcueidme.github.io/"; //更改为你的博客网址
var msgToTraditionalChinese = "简体/繁體"; //此处可以更改为你想要显示的文字
var msgToSimplifiedChinese = "繁體/简体"; //同上，但两处均不建议更改
var translateButtonId = "translateLink"; //默认互换id
var currentEncoding = defaultEncoding;
var targetEncodingCookie = "targetEncoding" + cookieDomain.replace(/\./g, "");
var targetEncoding = (getCookie(targetEncodingCookie) == null ? getDefaultEncoding(): getCookie(targetEncodingCookie));
...
function getDefaultEncoding() {
	...
	var countryCode = language.split('-').pop();
